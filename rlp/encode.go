...
var (
	...
	// RLP只编码的两种类型
	// 字符串，0x80代表字符串编码第一个字节的取值范围由0x80开始
	EmptyString = []byte{0x80}
	// 列表，0xC0代表列表的编码第一个字节的取值范围由0xC0开始
	EmptyList   = []byte{0xC0}
)
...
/*
	rlp编码，大部分的EncodeRLP方法都是直接调用该方法
*/
...
// makeWriter creates a encoder function for the given type.
// 通过给定的类型创建个编码器函数
